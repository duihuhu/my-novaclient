...
class FlavorManager(base.ManagerWithFind):
    ...
    def _build_body(self, name, ram, vcpus, disk, cache,id, swap,
    ...
    def create(self, name, ram, vcpus, disk, cache=0,flavorid="auto",
        ...
        try:
            ...
            raise exceptions.CommandError(_("Cache must be an integer."))
        ...
        body = self._build_body(name, ram, vcpus, disk, cache, flavorid, swap,
                                ephemeral, rxtx_factor, is_public)

        LOG.info('before_cache %s',cache)
